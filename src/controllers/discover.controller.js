...
const getContent = catchAsync(async (req, res) => {
  try {
    ...
    - Include both popular and obscure content across different formats that match or resonate with the user’s profile.
    ...
    TASK:
    Generate a JavaScript array of 6 content items (can be movies, documentaries, anime, animation, TV shows, or short films — be flexible).
